...
import StarRatgin from "./StarRating";
...
export default function App() {
  ...
  function handelSelecteMovie(id) {
      ...
      <Main>
        <Box>
          ...
          {!isLoading && !error && (
            <MovieList
              movies={movies}
              handelSelecteMovie={handelSelecteMovie}
            />
          )}
...
function MovieList({ movies, handelSelecteMovie }) {
  return (
...
function Movie({ movie, handelSelecteMovie }) {
  return (
    <li onClick={() => handelSelecteMovie(movie.imdbID)}>
